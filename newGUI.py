...
def main_screen():
    ...
    root.grid_rowconfigure(0, weight=10)  # Team frames
    root.grid_rowconfigure(1, weight=1)  # Game mode label
    root.grid_rowconfigure(2, weight=1)  # Buttons
    root.grid_rowconfigure(3, weight=1)  # Instructions
    ...
    # Add column headers
    tk.Label(red_team_frame, text="No.", font=MEDIUM_FONT, bg="#500000", fg="white", width=5).grid(row=1, column=0, padx=10, pady=10)
    tk.Label(red_team_frame, text="ID", font=MEDIUM_FONT, bg="#500000", fg="white").grid(row=1, column=1, padx=10, pady=10)
    tk.Label(red_team_frame, text="Name", font=MEDIUM_FONT, bg="#500000", fg="white").grid(row=1, column=2, padx=10, pady=10)

    tk.Label(green_team_frame, text="No.", font=MEDIUM_FONT, bg="#004d00", fg="white", width=5).grid(row=1, column=0, padx=10, pady=10)
    tk.Label(green_team_frame, text="ID", font=MEDIUM_FONT, bg="#004d00", fg="white").grid(row=1, column=1, padx=10, pady=10)
    tk.Label(green_team_frame, text="Name", font=MEDIUM_FONT, bg="#004d00", fg="white").grid(row=1, column=2, padx=10, pady=10)
    ...
    for i in range(num_players):
        ...
        red_player_id_entry.grid(row=row_num, column=1, padx=10, pady=1, sticky="ew")
        red_team_id_entries.append(red_player_id_entry)

        red_name_entry = tk.Entry(red_team_frame, width=20, font=MEDIUM_FONT)
        red_name_entry.grid(row=row_num, column=2, padx=10, pady=1, sticky="ew")
        ...
        ).grid(row=row_num, column=3, padx=10, pady=1)
        ...
        green_player_id_entry.grid(row=row_num, column=1, padx=10, pady=1, sticky="ew")
        green_team_id_entries.append(green_player_id_entry)

        green_name_entry = tk.Entry(green_team_frame, width=20, font=MEDIUM_FONT)
        green_name_entry.grid(row=row_num, column=2, padx=10, pady=1, sticky="ew")
    ...
    game_mode_label.grid(row=1, column=0, columnspan=2, pady=1)
